...
define(['jquery', 'underscore', 'oae/api/oae.core', 'jquery-plugins/imgareaselect/jquery.imgareaselect'], function($, _, oae) {
    ...
    return function(uid, showSettings, principal) {
                ...
                $(picForm).ajaxForm({
                    'success': function(data) {
                        ...
                        if (type === 'user') {
                            ...
                            principalData.largePicture = data.largePicture;
                        }
                        doInit();
                    },
                    'error': function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (type === 'user') {
                        ...
                        principalData.smallPicture = data.smallPicture;
                        principalData.mediumPicture = data.mediumPicture;
                    }

                    // Change all the pictures on the page.
                    for (var i = 0; i < imagesToChange.length; i++) {
                        $(imagesToChange[i]).attr('src', data.mediumPicture);
                    }
        ...
        $(document).on('init.changepic.sakai', function(ev, data) {
            ...
            id = (type === 'user') ? principalData.userId : principalData.id;
            modal.open();
        });
    };
});
