...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, contentObj) {
        ...
        var showViewMode = function() {
            ...
            if (contentObj.latestRevision && contentObj.latestRevision.etherpadHtml && contentObj.latestRevision.etherpadHtml.replace(/(<br>|&nbsp;)/g, '')) {
                $('#etherpad-view-mode-content', $rootel).html(contentObj.latestRevision.etherpadHtml);
            } else {
