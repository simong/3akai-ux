    ...
    {macro renderSummary(activity)}
        <div class="activity-summary-container clearfix">
            <div class="pull-left activity-entity-thumbnail">
                ${renderThumbnail(activity.primaryThumbnail.entity)}
            </div>
            <div class="activity-summary">
                ${oae.api.i18n.translate('__MSG__' + activity.summary.i18nKey + '__', 'activity', activity.summary.i18nArguments)}
                <small class="muted">${oae.api.l10n.timeAgo(activity.created)}</small>
            </div>
        </div>
    {/macro}
            ...
            {else}
                <ul class="row oae-list oae-list-grid" data-items="${activity.previews.length}">
                    {for item in activity.previews}
                        ${listItem(item.entity, null, false, null, null, 'col-xs-6 col-sm-4 col-md-3 col-lg-2')}
                    {/for}
                </ul>
