...
<div id="activity-new-item-template"><!--
    <div class="alert alert-info">
        <button id="activity-show-unread-activities" style="display:block; margin: 0 auto;" class="btn btn-primary" title="Show ${unReadActivities} more">Show ${unReadActivities} more</button>
    </div>
--></div>
