...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var initRightMenu = function() {
            if (oae.data.me.anon) {
                var signInWith = oae.api.i18n.translate('__MSG__SIGN_IN_WITH_X__', 'topnavigation');
                var casMsg = signInWith.replace('${0}', oae.api.config.getValue('oae-authentication', 'cas', 'name'));
                var shibMsg = signInWith.replace('${0}', oae.api.config.getValue('oae-authentication', 'shibboleth', 'name'));
                var data = {
                    'cas': casMsg,
                    'shibboleth': shibMsg
                };
                oae.api.util.renderTemplate('#topnavigation_right_anonymous_template', data, $('#topnavigation_right_content'));
            } else {
